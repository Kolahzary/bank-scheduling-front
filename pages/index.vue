<template>
  <div class="min-h-screen bg-gray-800 flex justify-center items-center">
    <div
      class="bg-gray-700 w-1/3 px-6 py-8 rounded-2xl shadow-3xl shadow-black"
    >
      ...
      <div class="mt-8">
        <select
          v-model="role"
          class="w-full text-gray-500 text-lg font-semibold bg-gray-700 border-b border-gray-500 py-1 outline-none focus:outline-none focus:border-green-400"
        >
      ...
      <div
        class="mt-12 w-full flex justify-center items-center bg-green-400 px-6 py-3 rounded-lg cursor-pointer"
        @click="start"
      >
